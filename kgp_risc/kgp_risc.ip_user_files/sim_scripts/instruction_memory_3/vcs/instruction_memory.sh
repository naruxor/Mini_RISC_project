...
#
# Script generated by Vivado on Tue Nov 12 16:16:41 +0530 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : instruction_memory.sh
...
#
# Usage        : instruction_memory.sh
#                instruction_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                instruction_memory.sh [-reset_run]
#                instruction_memory.sh [-reset_log]
#                instruction_memory.sh [-help]
#
...
#                script (type 'instruction_memory.sh -help' for more information).
#
...
# script info
echo -e "instruction_memory.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./instruction_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.instruction_memory xil_defaultlib.glbl -o instruction_memory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./instruction_memory_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key instruction_memory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc instruction_memory_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./instruction_memory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: instruction_memory.sh [-help]\n\
Usage: instruction_memory.sh [-step]\n\
Usage: instruction_memory.sh [-lib_map_path]\n\
Usage: instruction_memory.sh [-reset_run]\n\
Usage: instruction_memory.sh [-reset_log]\n\
Usage: instruction_memory.sh [-keep_index]\n\
Usage: instruction_memory.sh [-noclean_files]\n\n\
