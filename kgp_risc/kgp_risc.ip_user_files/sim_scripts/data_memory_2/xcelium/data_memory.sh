...
#
# Script generated by Vivado on Tue Nov 12 16:36:33 +0530 2024
...
#
# Usage        : data_memory.sh
#                data_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                data_memory.sh [-reset_run]
#                data_memory.sh [-reset_log]
#                data_memory.sh [-help]
#
...
#                script (type 'data_memory.sh -help' for more information).
#
...
# script info
echo -e "data_memory.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./data_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.data_memory xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.data_memory -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log data_memory_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: data_memory.sh [-step]\n\
Usage: data_memory.sh [-lib_map_path]\n\
Usage: data_memory.sh [-reset_run]\n\
Usage: data_memory.sh [-reset_log]\n\
Usage: data_memory.sh [-keep_index]\n\
