...
HD_PWD='C:/Users/thean_f8wkkz4/Documents/kgp_risc/kgp_risc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log risc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source risc.tcl -notrace
